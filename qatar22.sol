...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x295154671B9e366A7CC67bf4C1D41e41B2f628AA;
...
contract QATAR22 is Context, BEP20, Ownable {
    ...
    address private _developmentWalletAddress = 0x462fe5CbA27195054De093224142c3897aBe0562;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Qatar 22";
    string private _symbol = "QTR22";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 50;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 120;
